...
setup(
    ...
    entry_points={
	    ...
	    'lidar_camera_projection_detection = ros2_camera_lidar_fusion.lidar_camera_projection_detection:main',
	    'obstacle_avoidance = ros2_camera_lidar_fusion.obstacle_avoidance_node:main',
        ],
    },
)
