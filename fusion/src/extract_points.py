...
class ImageCloudCorrespondenceNode(Node):
    ...
    def pick_cloud_points(self, pcd_path):
        ...
        #pcd = o3d.io.read_point_cloud("/ros2_ws/p213.pcd")
        if pcd.is_empty():
        ...
        #vis.create_window(window_name="Select points on the cloud", width=1280, height=720, visible=True)
        ...
        #picked_xyz = [(-0.114,0.408,0.069),(0.123,0.354,0.114),(0.337,0.288,0.00678),(-0.116,0.383,-0.00922),(0.0874,0.292,-0.00517),(0.291,0.232,-0.00331)]
